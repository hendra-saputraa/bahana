...
const Home = () => {
  ...
  return (
    <div className="w-full h-auto flex flex-col items-center justify-center bg-primary">
      ...
      {searchTerm.length > 0 && (
        <p className="my-4 text-base text-color">
          Hasil untuk : 
    ...
    <>
      {musics?.map((data, index) => (
        <motion.div
          ...
          className="relative w-40 min-w-210 px-2 py-4 cursor-pointer hover:bg-gray-700 bg-card rounded-lg flex flex-col items-center"
